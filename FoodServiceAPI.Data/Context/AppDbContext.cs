    ...
    public class AppDbContext : IdentityDbContext<UserBase, ApplicationRole, int>
    {
        ...
        private void ConfigureInitialData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Ingredient>().HasData(
                new Ingredient { Id = 1, Name = "Tomato", Description = "Fresh and ripe, our tomatoes are harvested at the peak of perfection, ensuring unmatched flavor and quality.", StockQuantity = 100, ShortDescription = "Fresh Tomato", IsFresh = true, ExpirationDate = DateTime.Now.AddDays(7), Image = "https://i.imgur.com/dNT5NsS.jpg" },
                new Ingredient { Id = 2, Name = "Lettuce", Description = "Our lettuces are carefully grown, offering a crisp texture and a light flavor that perfectly complements any salad.", StockQuantity = 50, ShortDescription = "Crisp Lettuce", IsFresh = true, ExpirationDate = DateTime.Now.AddDays(5), Image = "https://i.imgur.com/dNT5NsS.jpg" },
                new Ingredient { Id = 3, Name = "Chicken Breast", Description = "Our chicken breasts are boneless and carefully prepared to ensure tender, juicy meat, perfect for a variety of dishes.", StockQuantity = 30, ShortDescription = "Boneless Chicken Breast", IsFresh = true, ExpirationDate = DateTime.Now.AddDays(3), Image = "https://i.imgur.com/dNT5NsS.jpg" },
                new Ingredient { Id = 4, Name = "Cheese", Description = "Our cheddar cheese is aged with care to develop its rich, creamy flavor, adding an irresistible touch to any dish.", StockQuantity = 40, ShortDescription = "Aged Cheddar Cheese", IsFresh = true, ExpirationDate = DateTime.Now.AddDays(10), Image = "https://i.imgur.com/dNT5NsS.jpg" },
                new Ingredient { Id = 5, Name = "Onion", Description = "Our fresh onions are hand-selected to ensure consistent quality and flavor, adding robust, aromatic taste to any dish.", StockQuantity = 60, ShortDescription = "Fresh Onion", IsFresh = true, ExpirationDate = DateTime.Now.AddDays(7), Image = "https://i.imgur.com/dNT5NsS.jpg" },
                new Ingredient { Id = 6, Name = "Lemon", Description = "Our fresh lemons are harvested at their peak of freshness, offering a citrusy, refreshing flavor that elevates any beverage or dish.", StockQuantity = 30, ShortDescription = "Fresh Lemon", IsFresh = true, ExpirationDate = DateTime.Now.AddDays(10), Image = "https://i.imgur.com/dNT5NsS.jpg" }
            );
